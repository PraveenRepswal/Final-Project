...
- **PostgreSQL** database (for ATS history, tracker, and session storage)
...
5. **Setup Environment Variables**:
   Create a `.env` file in the root directory and add the PostgreSQL URL and (optional) Gemini API Key:
   ```env
